...
namespace Player
{
    public class PlayerMoveView : IDisposable
    {
        ...
        public PlayerMoveView(IMovable movable, AudioSource source, GameObject runClip, Transform jumpTransform, PlayerConfig config)
        {
            _movable = movable;
            _audioSource = source;
